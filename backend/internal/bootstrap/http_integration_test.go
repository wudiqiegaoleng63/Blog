...
func TestHTTPBlogAndModerationFlow(t *testing.T) {
	...
	t.Setenv("REDIS_DIAL_TIMEOUT", "50ms")
	t.Setenv("REDIS_READ_TIMEOUT", "50ms")
	t.Setenv("REDIS_WRITE_TIMEOUT", "50ms")
	...
	list := performJSON(t, container.Router(), http.MethodGet, "/api/v1/posts/"+slug+"/comments", nil, "")
